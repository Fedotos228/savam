import { ServiceCards } from '@/types/home.types'
import Image from 'next/image'



export default function Card({ card }: { card: ServiceCards }) {
  return (
    <div className='group flex flex-col h-full transition-transform duration-300 hover:-translate-y-2 rounded-2xl'>
      <div className='overflow-hidden'>
        <Image
          ...
          height={200}
          loading="eager"
          className='w-full h-100 sm:h-120 lg:h-50 object-cover transition-transform duration-500 group-hover:scale-110'
        />
      </div>
